...
class MigrationPlanner:
    ...
    def generate_manifest_examples(
        self,
...
"""
    ...
    def flag_resources_needing_recreation(
        ...
        logger.info(f"Flagged {len(resources_to_recreate)} resources for potential recreation")
    ...
    def generate_migration_plan(
        ...
        manifest_examples = []
        for migration in migration_reqs.get('migrations', [])[:5]:  # Limit to 5 examples
    ...
    def _estimate_migration_time(self, migration_reqs: Dict[str, Any]) -> Dict[str, Any]:
        """
