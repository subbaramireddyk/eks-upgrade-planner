...
class EKSScanner:
    ...
    def list_node_groups(self, cluster_name: str) -> List[str]:
        ...
        try:
            ...
            logger.info(
                f"Found {len(node_groups)} node groups for cluster {cluster_name}"
            )
            return node_groups
        except ClientError as e:
    ...
    def describe_node_group(
        self, cluster_name: str, node_group_name: str
    ) -> Dict[str, Any]:
        """
    ...
    def describe_addon_versions(
        self, addon_name: Optional[str] = None, kubernetes_version: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
